...
|---|---|
| **Daily Plan** | **Start here.** Today's problems, in priority order: reviews due by spaced repetition, then approach practice that is due (a problem you solved with the wrong approach, three days after you last tried it), weak-pattern picks, and curriculum progression |
